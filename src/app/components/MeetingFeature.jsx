  ...
  return (
    <div className='flex flex-col items-center'>
      <div className='relative'>
        ...
        />
        <Button variant='ghost' size='icon' className='absolute top-1/2 -left-10 transform -translate-y-1/2 -translate-x-full cursor-pointer' onClick={prevSlide}>
          <ChevronLeft className='h-6 w-6'/>
        </Button>

        <Button variant='ghost' size='icon' className='absolute top-1/2 -right-25 transform -translate-y-1/2 -translate-x-full cursor-pointer' onClick={nextSlide}>
