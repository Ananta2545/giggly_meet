  ...
  return (
    <div className='flex items-center justify-between p-6 bg-white dark:bg-gray-900 border-b dark:border-gray-700'>
        <div className='flex items-center space-x-4'>
            ...
            <Video className='w-8 h-8 text-blue-500 cursor-pointer'/>
        ...
        <div className='flex items-center space-x-4'>
          ...
          <Button className='dark:border-white border-black cursor-pointer' variant='ghost' size='icon' onClick={()=> setTheme(theme==='dark'?"light": 'dark')}>
            {theme==='dark'?(
          ...
          <DropdownMenuTrigger asChild>
            ...
            <DropdownMenuContent align='end' className='w-80 p-4'>
                <div className='flex justify-between items-center mb-2'>
                    ...
                    <Button className='cursor-pointer rounded-full p-4' variant='ghost' size='icon' onClick={()=>setOpen(false)}>
                      <X className='h-5 w-5'/>
                    </Button>
                </div>
                ...
                <div className='flex mb-4'>
                        <Button className='cursor-pointer w-1/2 h-14 rounded-l-full' variant='outline'>
                          <Plus className='h-4 w-4 mr-2'/>
                          Add Account
                        </Button>
                        <Button className='cursor-pointer w-1/2 h-14 rounded-r-full' variant='outline' onClick={handleLogout}>
